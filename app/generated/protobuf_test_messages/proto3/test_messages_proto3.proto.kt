...
public data class TestAllTypesProto3(
  ...
  public val optional_nested_message: TestAllTypesProto3.NestedMessage,
  ...
  public val recursive_message: TestAllTypesProto3,
  ...
  public val repeated_nested_message: TestAllTypesProto3.NestedMessage,
  ...
  public val map_int32_int32: TestAllTypesProto3.MapInt32Int32Entry,
  @ProtoNumber(number = 57)
  public val map_int64_int64: TestAllTypesProto3.MapInt64Int64Entry,
  @ProtoNumber(number = 58)
  public val map_uint32_uint32: TestAllTypesProto3.MapUint32Uint32Entry,
  @ProtoNumber(number = 59)
  public val map_uint64_uint64: TestAllTypesProto3.MapUint64Uint64Entry,
  @ProtoNumber(number = 60)
  public val map_sint32_sint32: TestAllTypesProto3.MapSint32Sint32Entry,
  @ProtoNumber(number = 61)
  public val map_sint64_sint64: TestAllTypesProto3.MapSint64Sint64Entry,
  @ProtoNumber(number = 62)
  public val map_fixed32_fixed32: TestAllTypesProto3.MapFixed32Fixed32Entry,
  @ProtoNumber(number = 63)
  public val map_fixed64_fixed64: TestAllTypesProto3.MapFixed64Fixed64Entry,
  @ProtoNumber(number = 64)
  public val map_sfixed32_sfixed32: TestAllTypesProto3.MapSfixed32Sfixed32Entry,
  @ProtoNumber(number = 65)
  public val map_sfixed64_sfixed64: TestAllTypesProto3.MapSfixed64Sfixed64Entry,
  @ProtoNumber(number = 66)
  public val map_int32_float: TestAllTypesProto3.MapInt32FloatEntry,
  @ProtoNumber(number = 67)
  public val map_int32_double: TestAllTypesProto3.MapInt32DoubleEntry,
  @ProtoNumber(number = 68)
  public val map_bool_bool: TestAllTypesProto3.MapBoolBoolEntry,
  @ProtoNumber(number = 69)
  public val map_string_string: TestAllTypesProto3.MapStringStringEntry,
  @ProtoNumber(number = 70)
  public val map_string_bytes: TestAllTypesProto3.MapStringBytesEntry,
  @ProtoNumber(number = 71)
  public val map_string_nested_message: TestAllTypesProto3.MapStringNestedMessageEntry,
  @ProtoNumber(number = 72)
  public val map_string_foreign_message: TestAllTypesProto3.MapStringForeignMessageEntry,
  @ProtoNumber(number = 73)
  public val map_string_nested_enum: TestAllTypesProto3.MapStringNestedEnumEntry,
  @ProtoNumber(number = 74)
  public val map_string_foreign_enum: TestAllTypesProto3.MapStringForeignEnumEntry,
  @ProtoNumber(number = 111)
  public val oneof_uint32: UInt,
  @ProtoNumber(number = 112)
  public val oneof_nested_message: TestAllTypesProto3.NestedMessage,
