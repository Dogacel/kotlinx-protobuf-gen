package testgen.protobuf_test_messages.editions.proto3
...
public data class TestAllTypesProto3(
  ...
  public val optionalNestedEnum:
      NestedEnum = testgen.protobuf_test_messages.editions.proto3.TestAllTypesProto3.NestedEnum.FOO,
  @ProtoNumber(number = 22)
  public val optionalForeignEnum:
      ForeignEnum = testgen.protobuf_test_messages.editions.proto3.ForeignEnum.FOREIGN_FOO,
  @ProtoNumber(number = 23)
  public val optionalAliasedEnum:
      AliasedEnum = testgen.protobuf_test_messages.editions.proto3.TestAllTypesProto3.AliasedEnum.ALIAS_FOO,
  ...
  public val oneofNullValue: NullValue? = null,
  ...
  public val optionalAny: ProtobufAny? = null,
  @ProtoNumber(number = 306)
  public val optionalValue: Value? = null,
  @ProtoNumber(number = 307)
  public val optionalNullValue: NullValue = testgen.google.protobuf.NullValue.NULL_VALUE,
  ...
  public val repeatedAny: List<ProtobufAny?> = emptyList(),
...
@Serializable
public class NullHypothesisProto3() {
  override fun toString(): String = "NullHypothesisProto3"

  override fun hashCode(): Int = -1_881_398_322

  override fun equals(other: KotlinAny?): Boolean = other is NullHypothesisProto3
}

@Serializable
public class EnumOnlyProto3() {
  override fun toString(): String = "EnumOnlyProto3"

  override fun hashCode(): Int = -1_048_199_656

  override fun equals(other: KotlinAny?): Boolean = other is EnumOnlyProto3
