...
import testgen.repeateds.proto3.RepeatedsMessage

class RepeatedTest {
    @Test
    fun shouldDeSerAll() {
        val message = repeateds.proto3.Repeateds.RepeatedsMessage.newBuilder()
...
//            .addAllRepeatedSfixed64(listOf(1293L, 193L))
            ...
            .addAllRepeatedNestedMessage(
                listOf(
                    repeateds.proto3.Repeateds.RepeatedsMessage.NestedMessage.newBuilder().setA(-1).build(),
                    repeateds.proto3.Repeateds.RepeatedsMessage.NestedMessage.newBuilder().setA(3).build()
                )
            )
            .addAllRepeatedForeignMessage(
                listOf(
                    repeateds.proto3.Repeateds.ForeignMessage.newBuilder().setC(1).build(),
                    repeateds.proto3.Repeateds.ForeignMessage.newBuilder().build(),
                    repeateds.proto3.Repeateds.ForeignMessage.newBuilder().setC(-3).build()
                )
            )
//            .addAllRepeatedNestedEnum(
//                listOf(
//                    repeateds.proto3.Repeateds.RepeatedsMessage.NestedEnum.FOO,
//                    repeateds.proto3.Repeateds.RepeatedsMessage.NestedEnum.BAR,
//                    repeateds.proto3.Repeateds.RepeatedsMessage.NestedEnum.BAZ
//                )
//            )
//            .addAllRepeatedForeignEnum(
//                listOf(
//                    repeateds.proto3.Repeateds.ForeignEnum.FOREIGN_FOO,
//                    repeateds.proto3.Repeateds.ForeignEnum.FOREIGN_BAR,
//                    repeateds.proto3.Repeateds.ForeignEnum.FOREIGN_BAZ
//                )
//            )
            .build()
...
//        assertEquals(message.repeatedForeignMessageList, result.repeatedForeignMessage)
        ...
        val deser = repeateds.proto3.Repeateds.RepeatedsMessage.parseFrom(ProtoBuf.encodeToByteArray(result))
    ...
    fun shouldDeSerEmpty() {
        val message = repeateds.proto3.Repeateds.RepeatedsMessage.newBuilder().build()
